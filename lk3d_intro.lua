LK3D = LK3D or {}
LK3D.IntroUniv = LK3D.NewUniverse("lk3d_uni_intro")
...
LK3D.PushUniverse(LK3D.IntroUniv)
    LK3D.AddObjectToUniverse("plane_floor", "plane_hp")
    LK3D.SetObjectPosAng("plane_floor", Vector(0, 0, 0), Angle(0, 0, 90))
    LK3D.SetObjectFlag("plane_floor", "NO_SHADING", false)
    LK3D.SetObjectFlag("plane_floor", "NO_LIGHTING", false)
    LK3D.SetObjectFlag("plane_floor", "NO_VW_CULLING", true)
    LK3D.SetObjectScale("plane_floor", Vector(6, 6, 6))
    LK3D.SetObjectMat("plane_floor", "intro_plane")
    ...
    LK3D.SetObjectMat("loka_test", "intro_loka1")
    ...
    LK3D.SetObjectMat("plane_face", "lokaface2")
    LK3D.SetObjectHide("plane_face", true)
    LK3D.SetObjectFlag("plane_face", "NO_TRACE", true)

    LK3D.AddObjectToUniverse("plane_transp_paint", "plane")
    LK3D.SetObjectPosAng("plane_transp_paint", Vector(-.1825, 0, .25), Angle(0, 90, 0))
    LK3D.SetObjectFlag("plane_transp_paint", "NO_SHADING", true)
    LK3D.SetObjectFlag("plane_transp_paint", "NO_LIGHTING", false)
    LK3D.SetObjectScale("plane_transp_paint", Vector(.175, .175, .15))
    LK3D.SetObjectMat("plane_transp_paint", "intro_paint_loka3")


    LK3D.AddObjectToUniverse("plane_powered_by", "plane")
    LK3D.SetObjectPosAng("plane_powered_by", Vector(2, -.8, .5), Angle(0, -110, 0))
    LK3D.SetObjectFlag("plane_powered_by", "NO_SHADING", true)
    LK3D.SetObjectFlag("plane_powered_by", "NO_LIGHTING", true)
    LK3D.SetObjectFlag("plane_powered_by", "CONSTANT", true)
    LK3D.SetObjectFlag("plane_powered_by", "NORM_INVERT", true)
    LK3D.SetObjectScale("plane_powered_by", Vector(1, 1, 1))
    LK3D.SetObjectMat("plane_powered_by", "intro_sign_powered2")

    --intro_sign_powered


    LK3D.AddObjectToUniverse("cube_shadow1", "cube")
    LK3D.SetObjectPosAng("cube_shadow1", Vector(-.2, .6, .15), Angle(0, -8, 90))
    LK3D.SetObjectFlag("cube_shadow1", "NO_SHADING", false)
    LK3D.SetObjectFlag("cube_shadow1", "SHADING_SMOOTH", true)
    LK3D.SetObjectFlag("cube_shadow1", "SHADOW_VOLUME", true)
    --LK3D.SetObjectFlag("cube_shadow1", "SHADOW_ZPASS", true)
    LK3D.SetObjectFlag("cube_shadow1", "NO_LIGHTING", false)
    LK3D.SetObjectScale("cube_shadow1", Vector(.15, .15, .15))
    LK3D.SetObjectMat("cube_shadow1", "intro_box1")
...
function LK3D.RenderIntro()
    ...
    LK3D.PushUniverse(LK3D.IntroUniv)
        ...
        LK3D.SetObjectPos("cube_lightref", lip)
        ...
        LK3D.SetObjectPos("plane_powered_by", sip)
